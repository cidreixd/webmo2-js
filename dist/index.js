...
import { createMotor, createSyncMotor } from './motor';
import { http, socket } from './client';
export var motor1 = createMotor(1);
export var motor2 = createMotor(2);
export var motor = createSyncMotor();
export var httpClient = http();
export var socketClient = socket();
...
export var create = function (options) {
    var motor1 = createMotor(1);
    var motor2 = createMotor(2);
    var motor = createSyncMotor();
    var httpClient = http();
...
export var wait = function (millis) { return __awaiter(void 0, void 0, void 0, function () {
